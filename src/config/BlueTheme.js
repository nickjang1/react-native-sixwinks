...
export default {
    ...
    // Button
    btnFontFamily: 'Montserrat-UltraLight',
    ...
    fontLight: 'Montserrat-UltraLight',
    ...
    // Footer
    footerHeight: 55,
    footerDefaultBg: '#004058',


    //FooterTab
    tabBarTextColor: '#568090',
    ...
    listDividerBg: '#ddd',
    listItemHeight: 45,
    listItemPadding: (Platform.OS === 'ios' ) ? 8 : 8,
